...
trait UploadsFiles {
     ...
     */
    public function downloadFiles(Model $model, string $zipName, string $relationshipName = 'files'): BinaryFileResponse|StreamedResponse|null
    {
     ...
     * @return bool
     */
    public function uploadFiles(Model $model, array $data, string $key = 'files', string $relationshipName = 'files'): bool
    {
