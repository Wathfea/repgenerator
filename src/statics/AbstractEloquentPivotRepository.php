...
namespace App\Abstraction\Repository\Eloquent\Pivot;
 ...
 */
abstract class AbstractEloquentPivotRepository extends AbstractEloquentRepository implements PivotRepositoryInterface, EloquentPivotRepositoryInterface
{
    /**
