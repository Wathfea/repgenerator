    ...
    <div class="max-w-screen-2xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div v-if="choosing">
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-6">
                    <button @click="chooseWizzard" class="block w-full py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                        Wizzard
                    </button>
                </div>
            </div>
